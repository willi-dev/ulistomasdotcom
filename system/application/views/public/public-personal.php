			...
			<div class="photo span-24">
				...
				?>			
					...
					<?php
								...
								$arrayA=array('#','"');
								$arrayB=array('&#35','&#34');?>
								<div class="grid-wrapinnerbox"><img src="<?php echo base_url();?><?php echo str_replace($arrayA, $arrayB, $gpp->thumb); ?>" class="grid-image" /><img src="<?php echo base_url();?>asset/load.gif" alt="" class="loadingimg"/></div>
								<?php
